...
import { BG, db, speakEs, speakEn, speakEnSlow, SRClass, normText, scoreMatch, getDailyWords, loadProfiles, saveProfile, updateProfile, createProfile, getFamilyId, createFamily, makeCode } from './AppA.jsx';
