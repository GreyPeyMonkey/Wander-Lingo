...
const VOCAB_L1 = {
  greetings: { icon:"??", label:"Greetings", color:"#E8445A", words:[
    ...
    {es:"Adiós",             en:"Goodbye",         emoji:"??", hook:"ADD one more OH when leaving — ah-dee-OHS!"},
    ...
    {es:"Me llamo...",       en:"My name is...",   emoji:"???", hook:"ME + a LLAMA — MY llama's name is... YAH-mo!"},
  ...
  around: { icon:"???", label:"Around Town", color:"#DC6B19", words:[
    ...
    {es:"¿Habla inglés?",            en:"Do you speak English?",  emoji:"???", hook:"AH-bla — is this ABLE person speaking my language?"},
    ...
    {es:"A la derecha",              en:"To the right",           emoji:"??", hook:"DARE-echa — I DARE you to go RIGHT!"},
    {es:"A la izquierda",            en:"To the left",            emoji:"??", hook:"ees-kee-AIR-da — it's QUIRKY and airy going LEFT!"},
    {es:"Todo recto",                en:"Straight ahead",         emoji:"??", hook:"TODO RECTO — totally ERECT and straight ahead!"},
  ...
  feelings: { icon:"??", label:"Feelings", color:"#8B5CF6", words:[
    ...
    {es:"Te quiero",      en:"I love you",emoji:"??", hook:"tay KYER-oh — CHEER for the one you love — te CHEER-oh!"},
  ...
  school: { icon:"??", label:"School", color:"#3B82F6", words:[
    ...
    {es:"Lápiz",           en:"Pencil",               emoji:"??", hook:"LAH-pees — the PENCIL draws in LAPS around the page!"},
  ...
  numbers: { icon:"??", label:"Numbers", color:"#06B6D4", words:[
    {es:"Uno",   en:"One",   emoji:"1??", hook:"OO-no — ONE more OOH makes everything fun!"},
    {es:"Dos",   en:"Two",   emoji:"2??", hook:"DOSE — the doctor gives you TWO doses of medicine!"},
    {es:"Tres",  en:"Three", emoji:"3??", hook:"TRACE — THREE lines to trace on the paper!"},
    {es:"Cuatro",en:"Four",  emoji:"4??", hook:"KWAH-tro — FOUR QUARTERS make one dollar — KWAH-tro!"},
    {es:"Cinco", en:"Five",  emoji:"5??", hook:"SINK-oh — FIVE things fell into the SINK-oh!"},
    {es:"Seis",  en:"Six",   emoji:"6??", hook:"SACE — SIX geese went SACE SACE SACE!"},
    {es:"Siete", en:"Seven", emoji:"7??", hook:"see-EH-tay — SEVEN ate (see-ATE) nine for breakfast!"},
    {es:"Ocho",  en:"Eight", emoji:"8??", hook:"OH-cho — EIGHT is an OH with a CHO CHO train!"},
    {es:"Nueve", en:"Nine",  emoji:"9??", hook:"NWEH-bay — NINE bees went WHEW into the hive!"},
...
const VOCAB_L2 = {
  verbs: { icon:"?", label:"Verbs & Actions", color:"#7C3AED", words:[
    ...
    {es:"Hablo",            en:"I speak",          emoji:"???", hook:"AH-blo — I speak BLOW by blow — AH-blo!"},
  ...
  time: { icon:"??", label:"Time & Days", color:"#0369A1", words:[
    ...
    {es:"Lunes",          en:"Monday",        emoji:"1??", hook:"LOO-nes — MONDAY on the MOON — LUNAR Monday!"},
    {es:"Martes",         en:"Tuesday",       emoji:"2??", hook:"MAR-tays — TUESDAY on MARS with the MARTIANS!"},
    {es:"Miércoles",      en:"Wednesday",     emoji:"3??", hook:"mee-AIR-coh-les — WEDNESDAY in the AIR with the MERCURIANS!"},
    {es:"Jueves",         en:"Thursday",      emoji:"4??", hook:"HWEH-bes — THURSDAY we have WEBS — like JOVE the spider!"},
    {es:"Viernes",        en:"Friday",        emoji:"5??", hook:"bee-AIR-nes — FRIDAY in the AIR near VENUS — vee-AIR-nes!"},
    {es:"Sábado",         en:"Saturday",      emoji:"??", hook:"SAH-bah-do — SATURDAY in the SAHARA DESERT!"},
    {es:"Domingo",        en:"Sunday",        emoji:"??", hook:"doh-MING-go — SUNDAY with DOMINOES — dom-INGO!"},
  ...
  body: { icon:"??", label:"Body & Health", color:"#DC2626", words:[
    ...
    {es:"Ojo",                 en:"Eye",           emoji:"???", hook:"OH-ho — your EYE goes OH-HO when it sees something amazing!"},
    ...
    {es:"Necesito un médico",  en:"I need a doctor",emoji:"?????", hook:"MEH-dee-co — the MEDIC is your MEDICAL doctor!"},
    {es:"La farmacia",         en:"The pharmacy",  emoji:"??", hook:"far-MAH-see-ah — the PHARMACY is FAR-macia away!"},
    {es:"Tengo fiebre",        en:"I have a fever", emoji:"???", hook:"fee-EH-bray — FEVER is like a FEE you pay — fee-EH!"},
  ...
  descriptions: { icon:"??", label:"Describing Things", color:"#B45309", words:[
    ...
    {es:"Lejos",    en:"Far",       emoji:"???", hook:"LEH-hos — FAR like a LEGION of miles away!"},
  ...
  shopping: { icon:"??", label:"Shopping & Market", color:"#065F46", words:[
    ...
    {es:"Me llevo esto",         en:"I'll take this",      emoji:"???", hook:"YEH-bo — I'll TAKE it YEBO style — YEH-bo!"},
    ...
    {es:"El precio",             en:"The price",           emoji:"???", hook:"PREH-see-oh — the PRICE is oh so PRECIOUS!"},
    {es:"La bolsa",              en:"The bag",             emoji:"???", hook:"BOWL-sah — the BAG is shaped like a BOWL!"},
    ...
    {es:"Me da uno más",         en:"Give me one more",    emoji:"??", hook:"Give me UNO MAS — one MORE please!"},
  ]},
  weather: { icon:"???", label:"Weather", color:"#1D4ED8", words:[
    {es:"Hace calor",        en:"It's hot",          emoji:"??", hook:"AH-say cah-LOR — it makes CALOR — HOT HOT HOT!"},
    {es:"Hace frío",         en:"It's cold",         emoji:"??", hook:"FREE-oh — it's COLD and FREE-zing cold!"},
    {es:"Está lloviendo",    en:"It's raining",      emoji:"???", hook:"yo-bee-EN-do — it's raining LOVING drops from the sky!"},
    {es:"Hace viento",       en:"It's windy",        emoji:"??", hook:"bee-EN-to — WINDY like a VENT blowing hard!"},
    {es:"Está nublado",      en:"It's cloudy",       emoji:"??", hook:"noo-BLAH-do — CLOUDY and totally BLAH-do gray!"},
    {es:"¿Cómo está el clima?",en:"What's the weather like?",emoji:"???", hook:"KLEE-mah — the CLIMATE CLIME changes fast in Cuenca!"},
    {es:"Va a llover",       en:"It's going to rain",emoji:"??", hook:"yo-BAIR — it's going to rain like a LOVER of water!"},
    {es:"Hace buen tiempo",  en:"The weather is nice",emoji:"??", hook:"tee-EM-po — nice weather TEMPO — what a GOOD time!"},
    {es:"El sol",            en:"The sun",           emoji:"??", hook:"SOLE — the SUN is your SOLE friend on cold days!"},
    {es:"La lluvia",         en:"The rain",          emoji:"???", hook:"YOO-bee-ah — the rain goes YOOBIA YOOBIA down!"},
    {es:"La neblina",        en:"The fog",           emoji:"???", hook:"neh-BLEE-nah — FOG like a NEBULA floating down!"},
...
const STORIES = [
  ...
  },
  {
    ...
    panels:[
      ...
      {speaker:"Victor",  avatar:"???", es:"¡Miren qué frutas tan bonitas!",            en:"Look at these beautiful fruits!"},
      ...
      {speaker:"Victor",  avatar:"???", es:"¿Cuánto cuestan las naranjas?",            en:"How much do the oranges cost?"},
  ...
  },
  {
    ...
    panels:[
      ...
      {speaker:"Victor",  avatar:"???", es:"¿Qué quieren hacer mañana?",                 en:"What do you want to do tomorrow?"},
      ...
      {speaker:"Victor",  avatar:"???", es:"Sé dónde hay uno. Está muy cerca, a la derecha.", en:"I know where there is one. It's very close, to the right."},
      {speaker:"Peyton",  avatar:"??", es:"¡Papá sabe todo! Es muy inteligente.",        en:"Dad knows everything! He's very smart."},
      {speaker:"Victor",  avatar:"???", es:"¡Ja! Aprendo mucho viviendo aquí en Cuenca.", en:"Ha! I learn a lot living here in Cuenca."},
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:16}}>
      ...
      {SRClass&&<React.Fragment>
        ...
        <div style={{fontSize:13,color:"#9CA3AF",textAlign:"center"}}>{phase==="idle"?"Tap the mic and say it in Spanish!":phase==="listening"?"??? Listening — speak now!":""}</div>
      </React.Fragment>}
